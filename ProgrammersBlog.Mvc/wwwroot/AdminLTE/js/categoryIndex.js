$(document).ready(function () {
    ...
    $(document).on('click', '.btn-delete', function (event) {
        ...
        Swal.fire({
            ...
            text: `${categoryName} adlı kategori silinecektir. Bu işlem geri alınamaz!`,
            icon: "warning",
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (categoryDto.ResultStatus === 0) {
                            Swal.fire({
                                title: "Silindi!",
                                text: `${categoryDto.Category.Name} adlı kategori başarıyla silindi.`,
                                icon: "success"
                            });
        ...
        placeHolderDiv.on('click', '#btnUpdate', function (event) {
            ...
            $.post(actionUrl, dataToSend).done(function (data) {
                ...
                if (isValid) {
                    ...
                    categoryTableRowObject.hide();
                    categoryTableRow.replaceWith(newTableRowObject);
                    categoryTableRowObject.fadeIn(3500);
